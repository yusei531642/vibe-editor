...
const ja: Dict = {
  ...
  'handoff.create': '引き継ぎ書を作成',
  'handoff.startFresh': '引き継ぎから新規セッション',
  'handoff.created': '引き継ぎ書を保存しました',
  'handoff.started': '引き継ぎから新しいセッションを開始しました',
  'handoff.acknowledged': '引き継ぎ ack を受信し、旧セッションを退役しました',
  'handoff.error.noProject': 'プロジェクトルートが未設定です',
  'handoff.error.createFailed': '引き継ぎ書の作成に失敗しました',
  'handoff.error.startFailed': '引き継ぎセッションの開始に失敗しました',
...
const en: Dict = {
  ...
  'handoff.startFresh': 'Start fresh from handoff',
  'handoff.created': 'Handoff saved',
  'handoff.started': 'Started a fresh session from the handoff',
  'handoff.acknowledged': 'Handoff acknowledged; retired the old session',
  'handoff.error.noProject': 'Project root is not set',
  'handoff.error.createFailed': 'Failed to create handoff',
  'handoff.error.startFailed': 'Failed to start from handoff',
