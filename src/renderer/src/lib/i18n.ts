...
const ja: Dict = {
  ...
  'ctxMenu.revealInFileManager': 'エクスプローラーで表示',
  'canvasMenu.autoArrangeTeam': 'チームを自動整理',
  ...
  'toast.revealedInFileManager': 'エクスプローラーで表示しました',
  'toast.revealFailed': 'エクスプローラーを開けませんでした: {error}',
  ...
  'onboarding.continueHint': 'Enter で続ける',
  'onboarding.stepLabel.welcome': 'はじめに',
  'onboarding.stepLabel.appearance': '外観',
  'onboarding.stepLabel.workspace': 'ワークスペース',
  'onboarding.stepLabel.done': '完了',
  ...
  'onboarding.workspace.subtitle':
    'プロジェクトの場所を選んでください。次回以降は自動で開きます。',
...
const en: Dict = {
  ...
  'ctxMenu.revealInFileManager': 'Reveal in file manager',
  'canvasMenu.autoArrangeTeam': 'Auto-arrange team',
  ...
  'toast.copyFailed': 'Failed to copy: {error}',
  'toast.revealedInFileManager': 'Revealed in file manager',
  'toast.revealFailed': 'Failed to reveal in file manager: {error}',
  ...
  'onboarding.continueHint': 'Press Enter to continue',
  'onboarding.stepLabel.welcome': 'Welcome',
  'onboarding.stepLabel.appearance': 'Appearance',
  'onboarding.stepLabel.workspace': 'Workspace',
  'onboarding.stepLabel.done': 'Ready',
  'onboarding.welcome.eyebrow': 'vibe-editor',
  ...
  'onboarding.workspace.subtitle':
    'Pick a project folder to continue. We will reopen it next time.',
