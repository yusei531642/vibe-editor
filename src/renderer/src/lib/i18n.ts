...
const ja: Dict = {
  ...
  'canvas.spawnTeamMore': '最近使ったチーム…',
  'canvas.recent': '最近使ったチーム',
  'canvas.panels': 'パネル',
  'canvas.noRecentTeams': '最近使ったチームはありません。「チーム起動」で Leader を呼び出してください。',
  'canvas.clear': 'クリア',
...
const en: Dict = {
  ...
  'canvas.spawnTeamMore': 'Recent teams…',
  'canvas.recent': 'Recent',
  'canvas.panels': 'Panels',
  'canvas.noRecentTeams': 'No recent teams. Use “Spawn Team” to start a Leader.',
  'canvas.clear': 'Clear',
