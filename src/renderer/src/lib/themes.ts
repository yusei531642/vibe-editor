...
export const THEMES: Record<ThemeName, ThemeVars> = {
  'claude-dark': {
    ...
    textDim: '#a8a69c',
    textMute: '#6f6d64',
    surfaceGlass: 'rgba(20, 20, 19, 0.72)',
  ...
  'claude-light': {
    ...
    bgPanel: '#faf9f2',
    bgSidebar: '#f0ece1',
    bgToolbar: 'rgba(250, 249, 242, 0.78)',
    bgElev: '#ffffff',
    border: '#e8e3d4',
    borderStrong: '#d6cfba',
    ...
    textDim: '#6b6a63',
    textMute: '#9c9a8f',
    surfaceGlass: 'rgba(250, 249, 242, 0.78)',
  ...
  dark: {
    ...
    textDim: '#8a8f98',
    textMute: '#62666d',
    surfaceGlass: 'rgba(11, 13, 18, 0.72)',
